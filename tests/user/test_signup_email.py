...
def test_db_create(portal: anyio.abc.BlockingPortal):
    async def create_test_suite():
        await Error.bulk_create([
            ...
            Error(status_code=400, code='4000006'),
...
def test_signup_email_pass(client, portal: anyio.abc.BlockingPortal):
    res = client.post(
        URI,
        json={
...
def test_duplicate_email_fail(client):
    res = client.post(
        URI,
        json={
            "email": "unittest1@test.com",
